...
class CategoryController extends Controller
{
    ...
    {
        Category::where('id',$id)->update(['flag' => 1]);
        return redirect('admin/sub/categories')->with('success','Category deleted successfully');
    }
    ...
    public function index_sub2()
    {
        ...
        if (request()->ajax()) {
            $categories1 = Category::select('id')->where('flag',0)->where('parent_id',null)->get()->toArray();
