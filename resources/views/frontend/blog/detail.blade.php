...
@section('title', $blog->meta_title != '' ? $blog->meta_title : 'Buy Beauty Products Online | MakeUp Products Store In Bangalore')
@section('description',$blog->meta_description != '' ? $blog->meta_description : 'Are you looking for the best deals on all makeup and beauty brands? MakeUp Biography is your one stop solution for all your beauty related requirements.')
@section('keywords',$blog->keywords != '' ? $blog->keywords : '')
@section('og_title', $blog->og_title != '' ? $blog->og_title : 'Buy Beauty Products Online | MakeUp Products Store In Bangalore')
@section('og_description',$blog->og_description != '' ? $blog->og_description : 'Are you looking for the best deals on all makeup and beauty brands? MakeUp Biography is your one stop solution for all your beauty related requirements.')
@section('og_image',$blog->og_image != '' ? asset('storage/blogs/'.$blog->og_image) : '')
@section('twitter_title', $blog->og_title != '' ? $blog->og_title : 'Buy Beauty Products Online | MakeUp Products Store In Bangalore')
@section('twitter_description',$blog->og_description != '' ? $blog->og_description : 'Are you looking for the best deals on all makeup and beauty brands? MakeUp Biography is your one stop solution for all your beauty related requirements.')
