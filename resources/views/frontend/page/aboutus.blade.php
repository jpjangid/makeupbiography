<div class="l-wrap">
      ...
      <div class="c-header__menu-content">
        ...
        <nav itemscope itemtype="http://schema.org/SiteNavigationElement" class="c-mobile-menu c-mobile-menu--top-menu js-mobile-top-menu">
          <ul id="mobile-top-menu" class="c-mobile-menu__list">
            ...
            <li id="menu-item-163" class="c-mobile-menu__item current-menu-ancestor current-menu-parent c-mobile-menu__item--has-children menu-item-163">
              <a>Pages</a>
              <ul class="c-mobile-menu__submenu">
                <li id="menu-item-165" class="c-mobile-menu__subitem current-menu-item current_page_item menu-item-165">
                  <a href="https://parkofideas.com/luchiana/demo/about/" aria-current="page">About us</a>
                </li>
          ...
          <div class="c-header__col-center">
            <nav itemscope itemtype="http://schema.org/SiteNavigationElement" class="c-top-menu js-top-menu">
              <ul id="top-menu-desktop" class="c-top-menu__list c-top-menu__list--compact">
                ...
                <li class="c-top-menu__item current-menu-ancestor current-menu-parent c-top-menu__item--has-children menu-item-163 js-menu-item">
                  <a>Pages</a>
                  <ul class="c-top-menu__submenu c-top-menu__submenu--columns-1">
                    <li class="c-top-menu__subitem current-menu-item current_page_item menu-item-165 c-top-menu__subitem--collapse js-menu-item">
                      <a href="https://parkofideas.com/luchiana/demo/about/" aria-current="page">About us</a>
                    </li>
 ...
 c-page-header--page c-page-header--high c-page-header--custom-bg" style="background-color:#bebfc1;background-image:url(https://parkofideas.com/luchiana/demo/wp-content/uploads/2020/10/luchiana-2058254205.jpg);background-size: cover; background-repeat: no-repeat; background-position: center;">
						...
						-->
                                ...
                                <li class="c-breadcrumbs__item   c-breadcrumbs__item--last " itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                  <a itemprop="item" title="About us" href="https://parkofideas.com/luchiana/demo/about/">
                                  ...
                                  <div class="elementor-element elementor-element-bc4e9cd elementor-widget elementor-widget-ideapark-heading" data-id="bc4e9cd" data-element_type="widget" data-widget_type="ideapark-heading.default">
                                    <div class="elementor-widget-container">
                                      <div class="c-ip-heading c-ip-heading--default c-ip-heading--left c-ip-heading--tablet- c-ip-heading--mobile- c-ip-heading--bullet-hide">
                                        <span class="c-ip-heading__inner">Style too own civil out along. Perfectly offending this art attempted add arranging age gentleman concluded. Get who uncommonly our expression ten increasing considered occasional travelling.</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="elementor-column-wrap elementor-element-populated">
                                <div class="elementor-widget-wrap">
                                  <div class="elementor-element elementor-element-8c1e177 elementor-widget elementor-widget-ideapark-heading" data-id="8c1e177" data-element_type="widget" data-widget_type="ideapark-heading.default">
                                    <div class="elementor-widget-container">
                                      <div class="c-ip-heading c-ip-heading--default c-ip-heading--left c-ip-heading--tablet- c-ip-heading--mobile- c-ip-heading--bullet-hide">
                                        <span class="c-ip-heading__inner">Name were we at hope. Remainder household direction zealously the unwilling bed sex. Lose and gay ham sake met that. Stood her place one ten spoke yet. Head case knew ever set why over.</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                      ...
                      <div class="elementor-element elementor-element-90893ef elementor-widget elementor-widget-ideapark-heading" data-id="90893ef" data-element_type="widget" data-widget_type="ideapark-heading.default">
                        <div class="elementor-widget-container">
                          <div class="c-ip-heading c-ip-heading--default c-ip-heading--justify c-ip-heading--tablet- c-ip-heading--mobile- c-ip-heading--bullet-hide">
                            <span class="c-ip-heading__inner">Turpis duis nisl iaculis tincidunt fames feugiat consequat, sed blandit. Donec tempor ut suspendisse amet. Vulputate consequat pharetra sollicitudin pellentesque tristique. Nisi, viverra volutpat tellus nisi, mauris magna quis tristique lobortis. Pharetra porta cursus facilisis non dui sed sit. Rutrum dolor varius adipiscing quam nisl etiam. Tempus tempor egestas vitae molestie pulvinar integer posuere id lobortis.
                              <br />
                              <br />Sit nisi diam venenatis, tortor. Vitae varius cursus augue arcu viverra ipsum semper est. Turpis rutrum lectus semper tortor ut ullamcorper mauris.</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="elementor-column-wrap elementor-element-populated">
                    <div class="elementor-widget-wrap">
                      <div class="elementor-element elementor-element-5254ab8 elementor-absolute elementor-widget__width-auto elementor-widget elementor-widget-image" data-id="5254ab8" data-element_type="widget" data-settings="{&quot;_position&quot;:&quot;absolute&quot;}" data-widget_type="image.default">
                        <div class="elementor-widget-container">
                          <div class="elementor-image">
                            <img width="341" height="246" src="https://parkofideas.com/luchiana/demo/wp-content/uploads/2020/10/luchiana-2242231634.png" class="attachment-full size-full" alt="" loading="lazy" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="elementor-element elementor-element-f2808b7 elementor-widget__width-initial elementor-absolute elementor-widget elementor-widget-image" data-id="f2808b7" data-element_type="widget" data-settings="{&quot;_position&quot;:&quot;absolute&quot;}" data-widget_type="image.default">
                        <div class="elementor-widget-container">
                          <div class="elementor-image">
                            <img width="162" height="147" src="https://parkofideas.com/luchiana/demo/wp-content/uploads/2020/10/luchiana-2359558945.png" class="attachment-full size-full" alt="" loading="lazy" />
                          </div>
                        </div>
                      </div>
                    </div>
