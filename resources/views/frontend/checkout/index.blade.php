							...
							<div class=" js-sticky-sidebar-nearby ">
								<div class="c-cart__customer-details" id="customer_details">
									<div class="col-1">
										...
										@endforeach
											<input type="radio" name="addressSelect" onclick="addressChange(this)" value="new"><small>New</small><br>
										...
										<div class="c-cart__form c-cart__form--billing-fields woocommerce-billing-fields">
											...
											<div class="c-cart__billing-fields woocommerce-billing-fields__field-wrapper">
												...
												<p class="form-row form-row-first validate-required" data-priority="10">
													...
													<span class="woocommerce-input-wrapper">
														<input type="text" class="input-text number" name="billing_mobile" id="billing_mobile" placeholder="" value="" autocomplete="given-name" />
													</span>
												</p>
												<p class="form-row form-row-first validate-required" data-priority="10">
												...
												<td class="c-cart__totals-price">
													<span class="woocommerce-Price-amount amount">
														<bdi>
															...
															<input type="text" name="regular_price" id="regular_price" value="{{ $regular_price }}">
														</bdi>
													</span>
												</td>
											</tr>
											<tr class="cart-subtotal">
												...
												<td class="c-cart__totals-price">
													<span class="woocommerce-Price-amount amount">
														<bdi>
															<span class="woocommerce-Price-currencySymbol">&#8377;</span>
															<input type="text" name="product_discount" id="product_dis" value="{{ $discountPrice }}">
														</bdi>
													</span>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="c-cart__totals-price">
													<span class="woocommerce-Price-amount amount">
														<bdi>
															<span class="woocommerce-Price-currencySymbol">&#8377;</span>
															<input type="text" name="coupon_discount" id="coupon_dis" value="{{ $coupon_dis }}">
														</bdi>
													</span>
												</td>
											</tr>
											<tr>
												...
												<td class="c-cart__totals-price">
													<span class="woocommerce-Price-amount amount">
														<bdi>
															<span class="woocommerce-Price-currencySymbol">&#8377;</span>
															<input type="text" name="shipping_charge" id="shipping_chrg" value="100">
														</bdi>
													</span>
												</td>
											</tr>
												...
												<td class="c-cart__totals-price c-cart__totals-price--total" data-title="Total">
													<strong>
														<span class="woocommerce-Price-amount amount">
															<bdi>
																<span class="woocommerce-Price-currencySymbol">&#8377;</span>
																<input type="text" name="total" id="total_price" value="{{ $totalPrice }}">
															</bdi>
														</span>
													</strong>
												</td>
