...
<head>
  ...
  <title>Wide Home &#8211; Luchiana</title>
...
<body class="page-template page-template-elementor_header_footer page page-id-1131 theme-luchiana woocommerce-no-js woo-variation-swatches wvs-theme-luchiana wvs-theme-child-luchiana wvs-style-rounded wvs-attr-behavior-blur wvs-tooltip wvs-css woocommerce-on h-ltr h-wpml elementor-default elementor-template-full-width elementor-kit-37 elementor-page elementor-page-1131">
  ...
  document.addEventListener("DOMContentLoaded",function(){setTimeout(function(){document.body.insertAdjacentHTML("beforeEnd", '<a href="https://themeforest.net/item/luchiana-cosmetics-beauty-shop-woocoomerce-theme/29332516" target="_parent"><img class="ip-buy-now loading" id="ip-buy-now" src="https://parkofideas.com/luchiana/demo/wp-content/plugins/ideapark-theme/img/buy-now.svg" alt="Buy Now!"/></a>');setTimeout(function(){document.getElementById("ip-buy-now").classList.remove("loading")}, 100);}, 5000);})
  </script>
