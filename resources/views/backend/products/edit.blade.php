                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="cat" class="form-control form-control-solid">
                                            ...
                                            @foreach($cats as $cat)
                                                @php
                                                    $selected = '';
                                                    $selected = $product->parent_id == $cat['id'] ? 'selected' : '';
                                                @endphp
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="sub_cat" class="form-control form-control-solid">
                                            ...
                                            @foreach($sub_cats as $sub_cat)
                                                @php
                                                    $selected = '';
                                                    $selected = $product->parent_id == $sub_cat['id'] ? 'selected' : '';
                                                @endphp
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('alt_title') is-invalid @enderror" name="alt" id="alt_title" placeholder="Please Enter Alt Title" value="{{ $product->alt }}">
                                ...
                                <div class="col-md-10 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('tags') is-invalid @enderror" name="tags" id="tags" value="{{ $product->tags }}" placeholder="Please Enter Meta Tag" />
                                        @error('tags')
                                        <span class="error invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
