                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools mt-4">
                            <a href="{{ url('admin/contact_us/create') }}" class="btn btn-active-light-primary">
                                + Add Contact Us
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-row-bordered table-hover text-nowrap" id="contactTable">
                            <thead>
