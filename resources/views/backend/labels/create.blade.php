        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ url('admin/labels/store') }}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid @error('name') is-invalid @enderror" name="name" id="name" placeholder="Please Enter Label Name" value="{{ old('name') }}">
                                        @error('name')
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-active-light-primary">Add Label</button>
